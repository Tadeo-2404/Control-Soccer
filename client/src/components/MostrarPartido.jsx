        ...
        <form action="">
            ...
            <div>
                <select name="Convovatoria" id="Convovatoria" class="box">
                    <option value="Categoria sub-15" class="vl">Categoria sub-15</option>
                    <option value="Categoria sub-17" class="vl">Categoria sub-17</option>
                    <option value="Categoria sub-18" class="vl">Categoria sub-18</option>
                    <option value="Categoria sub-21" class="vl">Categoria sub-21</option>
                </select>
            </div>
